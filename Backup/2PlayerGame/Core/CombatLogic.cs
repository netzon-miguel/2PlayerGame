    ...
    class CombatLogic : ICombatService
    {
        ...
        public void Battle(IPlayer player1, IPlayer player2)
        {
            ...
            while (player1.Health > 0 && player2.Health > 0)
            {
                ...
                if (turn)
                {
                    Console.Write(String.Format(ApplicationSettings.ActionChoose, player1.CharacterName));
                ...
                {
                    Console.Write(String.Format(ApplicationSettings.ActionChoose, player2.CharacterName));
                    if ((ActionSelection)Enum.Parse(typeof(ActionSelection),
                                                  Console.ReadLine(),
                                                  true)
                                                  == ActionSelection.Attack)
